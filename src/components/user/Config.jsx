...
export const Config = () => {
  ...
  const updateUser = async (e) => {
    ...
    try {
      ...
      const userUpdateResponse = await fetch(`${Global.API_URL}user/update`, {
        method: 'PUT',
  ...
  const uploadAvatar = async (file, token) => {
    try {
      ...
      const uploadResponse = await fetch(`${Global.API_URL}user/upload`, {
        method: 'POST',
        body: formData,
        headers: {
          Authorization: token
              ...
              <div className='avatar'>
                <div className='general-info__container-avatar'>
                  {auth.image !== 'default.png'
                    ? (
                      <img src={`${Global.API_URL}user/avatar/${auth.image}`} className='container-avatar__img' alt='Foto de perfil' />
                      )
                    : (

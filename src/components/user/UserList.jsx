...
export const UserList = ({ users, getUsers, following, setFollowing, more, page, setPage }) => {
  ...
  const follow = async (userId) => {
    ...
    const request = await fetch(Global.API_URL + 'follow/follow', {
      method: 'POST',
  ...
  const unfollow = async (userId) => {
    ...
    const request = await fetch(Global.API_URL + 'follow/unfollow/' + userId, {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json',
        Authorization: token
                  ...
                  <div className='avatar'>
                    <div className='general-info__container-avatar'>
                      {user.image && user.image !== 'default.png'
                        ? (
                          <img src={`${Global.API_URL}user/avatar/${user.image}`} className='container-avatar__img' alt='Foto de perfil' />
                          )
                        : (
